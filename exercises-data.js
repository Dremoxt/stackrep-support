...
const EXERCISES = [
  ...
  // ── Chest ────────────────────────────────────────────────────────────
  { id:'push-up', name:'Push-Up', category:'Chest', type:'Bodyweight', position:'Prone', extra:'none', emoji:'💪',
  ...
  { id:'band-chest-press', name:'Band Chest Press', category:'Chest', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'🎯',
  ...
  { id:'band-push-up', name:'Band Push-Up', category:'Chest', type:'Resistance Band', position:'Prone', extra:'none', emoji:'💪',
  ...
  { id:'band-chest-fly', name:'Band Chest Fly', category:'Chest', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'🦅',
  ...
  { id:'incline-push-up', name:'Incline Push-Up', category:'Chest', type:'Bodyweight', position:'Prone (hands elevated)', extra:'chair', emoji:'📐',
    description:'Same form as a push-up but with hands on a raised surface — easier, great for higher reps.' },

  { id:'band-incline-press', name:'Band Incline Press', category:'Chest', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'⬆️',
    description:'Press up and forward at an angle toward the ceiling, targeting the upper chest. Anchor the band low behind you.' },

  // ── Back ─────────────────────────────────────────────────────────────
  { id:'superman', name:'Superman', category:'Back', type:'Bodyweight', position:'Prone', extra:'none', emoji:'🦸',
    description:'Lying face down, lift arms, chest, and legs off the floor at once; hold briefly and lower.' },

  { id:'band-lat-pulldown', name:'Band Lat Pulldown', category:'Back', type:'Resistance Band', position:'Standing or kneeling', extra:'anchor', emoji:'⬇️',
  ...
  { id:'band-bent-over-row', name:'Band Bent-Over Row', category:'Back', type:'Resistance Band', position:'Standing', extra:'none', emoji:'🚣',
    description:'Stand on the band, hinge forward with a flat back, pull the handles to your waist driving the elbows back.' },

  { id:'band-seated-row', name:'Band Seated Row', category:'Back', type:'Resistance Band', position:'Seated', extra:'none', emoji:'🧘',
  ...
  { id:'inverted-row', name:'Inverted Row', category:'Back', type:'Bodyweight', position:'Lying face up', extra:'bar', emoji:'🔄',
    description:'Hang under a bar or sturdy table with body straight, pull your chest up to it, then lower under control.' },

  { id:'band-straight-arm-pulldown', name:'Band Straight-Arm Pulldown', category:'Back', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'👐',
    description:'Keep arms straight, pull the band from overhead down to your thighs in a sweeping arc. Anchor the band high.' },

  // ── Shoulders ────────────────────────────────────────────────────────
  { id:'pike-push-up', name:'Pike Push-Up', category:'Shoulders', type:'Bodyweight', position:'Prone (hips piked high)', extra:'none', emoji:'🔺',
    description:'In an inverted-V position, bend the elbows to lower the crown of your head toward the floor, then press up.' },

  { id:'band-overhead-press', name:'Band Overhead Press', category:'Shoulders', type:'Resistance Band', position:'Standing', extra:'none', emoji:'🏆',
    description:'Stand on the band. From shoulder height, press the handles straight overhead until arms lock out, then lower.' },

  { id:'band-lateral-raise', name:'Band Lateral Raise', category:'Shoulders', type:'Resistance Band', position:'Standing', extra:'none', emoji:'↔️',
  ...
  { id:'band-front-raise', name:'Band Front Raise', category:'Shoulders', type:'Resistance Band', position:'Standing', extra:'none', emoji:'🚩',
    description:'Stand on the band. Arms straight, raise the handles forward and up to shoulder height, then lower.' },

  { id:'wall-handstand-hold', name:'Wall Handstand Hold', category:'Shoulders', type:'Bodyweight', position:'Inverted', extra:'wall', emoji:'🤸',
    description:'Kick up to a handstand with heels resting on the wall; hold a tight, straight body and breathe.' },

  { id:'band-face-pull', name:'Band Face Pull', category:'Shoulders', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'🎯',
  ...
  // ── Biceps ───────────────────────────────────────────────────────────
  { id:'chin-up', name:'Chin-Up', category:'Biceps', type:'Bodyweight', position:'Hanging', extra:'bar', emoji:'🏋️',
  ...
  { id:'band-biceps-curl', name:'Band Biceps Curl', category:'Biceps', type:'Resistance Band', position:'Standing', extra:'none', emoji:'💪',
    description:'Stand on the band. Elbows pinned to your sides, curl the handles up to your shoulders, then lower slowly.' },

  { id:'band-hammer-curl', name:'Band Hammer Curl', category:'Biceps', type:'Resistance Band', position:'Standing', extra:'none', emoji:'🔨',
    description:'Stand on the band. Same as a curl but palms face each other throughout — targets the outer arm and forearm.' },

  { id:'band-concentration-curl', name:'Band Concentration Curl', category:'Biceps', type:'Resistance Band', position:'Seated', extra:'chair', emoji:'🎯',
  ...
  { id:'towel-isometric-curl', name:'Towel Isometric Curl', category:'Biceps', type:'Bodyweight', position:'Seated', extra:'chair', emoji:'🧣',
    description:'Loop a towel under one thigh, pull up hard with the arm while resisting with the leg; hold the tension.' },

  { id:'band-wide-curl', name:'Band Wide Curl', category:'Biceps', type:'Resistance Band', position:'Standing', extra:'none', emoji:'↔️',
  ...
  // ── Triceps ──────────────────────────────────────────────────────────
  { id:'chair-dips', name:'Chair Dips', category:'Triceps', type:'Bodyweight', position:'Seated edge', extra:'chair', emoji:'🪑',
    description:'Hands on the seat behind you, lower your body by bending the elbows, then press back up.' },

  { id:'diamond-push-up', name:'Diamond Push-Up', category:'Triceps', type:'Bodyweight', position:'Prone', extra:'none', emoji:'💎',
    description:'Push-up with hands close together forming a diamond shape under your chest — hits the triceps hard.' },

  { id:'band-triceps-pushdown', name:'Band Triceps Pushdown', category:'Triceps', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'⬇️',
    description:'Elbows tucked, push the band down until arms are straight, then return slowly. Anchor the band high.' },

  { id:'band-overhead-extension', name:'Band Overhead Extension', category:'Triceps', type:'Resistance Band', position:'Standing', extra:'none', emoji:'🙌',
  ...
  { id:'bench-dips-elevated', name:'Bench Dips, Feet Elevated', category:'Triceps', type:'Bodyweight', position:'Seated edge', extra:'chair', emoji:'🪑',
    description:'Harder version of chair dips — feet elevated on a second surface increases the load significantly.' },

  { id:'band-kickback', name:'Band Kickback', category:'Triceps', type:'Resistance Band', position:'Standing (hinged forward)', extra:'none', emoji:'🦵',
    description:'Stand on the band, hinge forward, upper arms still; extend the forearms straight back until arms are locked out.' },

  // ── Legs ─────────────────────────────────────────────────────────────
  { id:'bodyweight-squat', name:'Bodyweight Squat', category:'Legs', type:'Bodyweight', position:'Standing', extra:'none', emoji:'🦵',
    description:'Feet shoulder-width, sit hips back and down until thighs are about parallel, then drive up through your heels.' },

  { id:'lunge', name:'Walking / Reverse Lunge', category:'Legs', type:'Bodyweight', position:'Standing', extra:'none', emoji:'🚶',
    description:'Step forward (or back), lowering the back knee toward the floor, then push back to standing; alternate legs.' },

  { id:'band-squat', name:'Band Squat', category:'Legs', type:'Resistance Band', position:'Standing', extra:'none', emoji:'💪',
    description:'Stand on the band with handles at shoulder height. Perform a squat — resistance increases as you stand up.' },

  { id:'band-glute-bridge', name:'Band Glute Bridge', category:'Legs', type:'Resistance Band', position:'Lying', extra:'none', emoji:'🌉',
    description:'On your back, knees bent, band over hips; drive hips up squeezing the glutes against the band, then lower.' },

  { id:'single-leg-glute-bridge', name:'Single-Leg Glute Bridge', category:'Legs', type:'Bodyweight', position:'Lying', extra:'none', emoji:'🦶',
    description:'Glute bridge with one foot off the floor — all the work on one leg; switch sides.' },

  { id:'band-lateral-walk', name:'Band Lateral Walk', category:'Legs', type:'Resistance Band', position:'Standing', extra:'none', emoji:'↔️',
  ...
  // ── Core ─────────────────────────────────────────────────────────────
  { id:'plank', name:'Plank', category:'Core', type:'Bodyweight', position:'Prone (on forearms)', extra:'none', emoji:'📏',
    description:'Hold a straight line from head to heels, bracing your abs and glutes; don\'t let the hips sag.' },

  { id:'bicycle-crunch', name:'Bicycle Crunch', category:'Core', type:'Bodyweight', position:'Lying', extra:'none', emoji:'🚴',
    description:'Bring opposite elbow to opposite knee while extending the other leg, alternating in a pedaling motion.' },

  { id:'band-pallof-press', name:'Band Pallof Press', category:'Core', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'🔄',
  ...
  { id:'band-dead-bug', name:'Band Dead Bug', category:'Core', type:'Resistance Band', position:'Lying', extra:'anchor', emoji:'🪲',
  ...
  { id:'mountain-climbers', name:'Mountain Climbers', category:'Core', type:'Bodyweight', position:'Prone (in a plank)', extra:'none', emoji:'⛰️',
    description:'From a plank, drive your knees toward your chest one at a time, quickly, keeping hips low.' },

  { id:'band-woodchopper', name:'Band Woodchopper', category:'Core', type:'Resistance Band', position:'Standing', extra:'anchor', emoji:'🪓',
